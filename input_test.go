...
func TestSpecialKeys(t *testing.T) {
	tests := []struct {
		...
		{"SS3-Keypad-0", []byte{'\x1b', 'O', 'p'}, KeyInsert, ModNone, ""},
		{"SS3-Keypad-1", []byte{'\x1b', 'O', 'q'}, KeyEnd, ModNone, ""},
		{"SS3-Keypad-2", []byte{'\x1b', 'O', 'r'}, KeyDown, ModNone, ""},
		{"SS3-Keypad-3", []byte{'\x1b', 'O', 's'}, KeyPgDn, ModNone, ""},
		{"SS3-Keypad-4", []byte{'\x1b', 'O', 't'}, KeyLeft, ModNone, ""},
		{"SS3-Keypad-5", []byte{'\x1b', 'O', 'u'}, KeyClear, ModNone, ""},
		{"SS3-Keypad-6", []byte{'\x1b', 'O', 'v'}, KeyRight, ModNone, ""},
		{"SS3-Keypad-7", []byte{'\x1b', 'O', 'w'}, KeyHome, ModNone, ""},
		{"SS3-Keypad-8", []byte{'\x1b', 'O', 'x'}, KeyUp, ModNone, ""},
		{"SS3-Keypad-9", []byte{'\x1b', 'O', 'y'}, KeyPgUp, ModNone, ""},
		{"SS3-Keypad-Enter", []byte{'\x1b', 'O', 'M'}, KeyEnter, ModNone, ""},
		{"SS3-Keypad-Decimal", []byte{'\x1b', 'O', 'n'}, KeyDelete, ModNone, ""},
		{"SS3-Keypad-Multiply", []byte{'\x1b', 'O', 'j'}, KeyRune, ModNone, "*"},
		{"SS3-Keypad-Add", []byte{'\x1b', 'O', 'k'}, KeyRune, ModNone, "+"},
		{"SS3-Keypad-Comma", []byte{'\x1b', 'O', 'l'}, KeyRune, ModNone, ","},
